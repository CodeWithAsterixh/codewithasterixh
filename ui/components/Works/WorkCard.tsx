...
function WorkCard({ datas }: Props) {
  return (
    <div className="group w-full flex-grow basis-64 flex flex-col gap-2 rounded-md p-3 sm:w-52 md:w-72 bg-base-black/5 dark:bg-base-white/5 backdrop-blur-md">
      <span
        className={clsx(
