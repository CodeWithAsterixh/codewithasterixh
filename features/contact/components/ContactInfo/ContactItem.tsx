...
export const ContactItem: React.FC<ContactItemProps> = ({ icon: Icon, title, details }) => {
  return (
    <div className="flex items-start gap-6 mb-8">
      <div className="flex items-center justify-center w-16 h-16 rounded-md bg-linear-to-br from-[#1a1a1a] to-[#0f0f0f] border border-white/5 shadow-lg shrink-0">
        <Icon size={28} weight="duotone" className="text-white/70" />
      </div>
